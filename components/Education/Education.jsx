    ...
    const educationList = [
        {
            ...
            year: "2020-2023",
            logo: "/images/icon/diu.png",
            cgpa: "CGPA: 3.83/4.00",
            background: "/images/icon/diu-bg.jpeg",
        },
        {
            id: 2,
            ...
            year: "2018",
            logo: "/images/icon/cgwc.png",
            cgpa: "GPA: 4.33/5.00",
            background: "/images/icon/cgwc-bg.jpg",
        },
        {
            id: 3,
            ...
            year: "2016",
            logo: "/images/icon/cgghss.png",
            cgpa: "GPA: 5.00/5.00",
            background: "/images/icon/cgghs-bg.jpeg",
        },
    ];
    ...
    return (
        <div id="education" className="w-full px-4 sm:px-6 lg:px-12 2xl:px-24 py-10 lg:py-32 xl:py-40 bg-gradient-to-b from-gray-50 to-white dark:from-black dark:to-gray-900 relative transition-colors duration-300">
            ...
            <SectionTitle
                ...
                title="Education"
                description="A summary of my educational journey"
            />
